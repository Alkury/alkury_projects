# 🌟 Хаб полезных проектов от Alkury
...
6. **[bot_price_tokens](https://github.com/Alkury/alkury_projects/tree/main/sender_gifts)** - Юзербот + бот работают в связке чтобы отправлять подарки телеграм доступные по апи 
